              ...
              <div className="flex-1 flex ">
                <form className="w-full flex md:ml-0" action="#" method="GET">
                  ...
                  <div className="relative w-full text-gray-400 focus-within:text-gray-600">
                    ...
                    <input
                      id="search-field"
                      className="block w-full h-full pl-8 pr-3 py-2 border-transparent bg-gray-800 text-gray-300 placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-0 focus:border-transparent sm:text-sm"
                      placeholder="Search"
                      type="search"
                      name="search"
                    />
