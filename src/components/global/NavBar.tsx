					...
					<div className="container xl:max-w-7xl mx-auto px-4 lg:px-8">
						<div className="flex justify-between py-4">
							...
							<div className="flex items-center">
								{/* Logo */}
								<a href="#" className="group inline-flex items-center text-center space-x-2 font-bold text-lg tracking-wide text-gray-700 hover:text-blue-600 active:text-gray-700">
								...
								{/* Search bar */}
								<div className="flex flex-row m-4 xl:ml-6 border-2 rounded border-slate-300 p-1 xl:min-w-full text-sm items-center">
